...
<meta name="viewport" content="initial-scale=1.0, maximum-scale=1.0, user-scalable=no">
    ...
    <link rel="stylesheet" href="css/dashbord_aboutus_style.css">
...
<div class="fdl">
            <fieldset class="col-md-12">
                <legend style="color:white;"><spam class="leg_ti">Raj Solanki</spam></legend>
                    <div style="color: white; background-color: black;">
                      <table>
                        <tr name="photo">
                          <div class="">
                           <img src="images/bg3.jpg" alt="Avatar" class="pro_pic">
                          </div>
                        </tr>
...
<div class="fdl">
            <fieldset class="col-md-12">
                <legend style="color:white;"><spam class="leg_ti">Ravi Patel</spam></legend>
                <div style="color: white; background-color: black;">
...
<div class="fdl">
            <fieldset class="col-md-12">
                <legend style="color:white;"><spam class="leg_ti">Pruthvi Patel</spam></legend>
                <div style="color: white; background-color: black;">
...
<div class="fdl">
            <fieldset class="col-md-12">
                <legend style="color:white;"><spam class="leg_ti">Jainam Sutariya</spam></legend>
                <div style="color: white; background-color: black;">
